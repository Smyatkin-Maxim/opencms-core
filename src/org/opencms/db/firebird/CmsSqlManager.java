...
package org.opencms.db.firebird;

/**
 * Firebird implementation of the SQL manager.<p>
 * 
 * @since 9.5.1
 */
public class CmsSqlManager extends org.opencms.db.generic.CmsSqlManager {
    ...
    private static final String QUERY_PROPERTIES = "org/opencms/db/firebird/query.properties";
